...
object SharedPrefManager {
    ...
    fun setSearchHistoryMode(isActivated: Boolean){
        Log.d(TAG, "SharedPrefManager - setSearchHistoryMode() is called / isActivated: $isActivated")
    ...
    fun CheckSearchHistoryMode() : Boolean{
        ...
        val isSearchHistoryMode : Boolean = shared.getBoolean(KEY_SEARCH_HISTORY_MODE, false)
